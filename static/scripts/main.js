(function(){
  ...
  if(cart.length > 0) {
		...
		function addProduct(target) {
			...
			var productAdded = '<li class="cd-cart__product" id="cart_product_'+id+'"><div class="cd-cart__image"><a href="#0"><img src="../static/images/'+image+'" alt="placeholder"></a></div><div class="cd-cart__details"><h3 class="truncate"><p class="cart_dish" id="cart_dish_'+id+'"> </p></h3><span class="cd-cart__price" id="cart_price_'+id+'"></span><div class="cd-cart__actions"><a href="#0" class="cd-cart__delete-item">Delete</a><div class="cd-cart__quantity"><label style="font-size: 20px;">Qty</label><button class="cart_sub_add cd-add-to-cart js-cd-add-to-cart" id="cart_subtract_'+id+'" onclick="cartSubButton(this.id)">-</button><input class="cart-input" type="number" id="cart_qty_'+id+'"><button class="cart_sub_add cd-add-to-cart js-cd-add-to-cart" id="cart_add_'+id+'" onclick="cartAddButton(this.id)">+</button></div></div></div></li>';
